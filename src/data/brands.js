...
export const BRANDS = [
  {
    ...
    media: [
      ...
      { id: 2, type: "image", src: insta1, title: "Collectible Ticket Series", tag: "Print Work" },
      { id: 3, type: "image", src: insta2, title: "Premiere Night Digital Banner", tag: "Digital Poster" },
      { id: 4, type: "image", src: insta3, title: "Dolby Atmos Visualizer", tag: "Social Media" },
      { id: 5, type: "image", src: insta4, title: "Concession Menu Board", tag: "Menu Design" },
    ],
  },
  {
    // id: "02",
    ...
    media: [
      { id: 1, type: "image", src: brand2, title: "Neon Nights Identity", tag: "Brand Visual" },
      { id: 2, type: "image", src: insta3, title: "Mixology Spotlight", tag: "Cocktail Series" },
      { id: 3, type: "image", src: insta4, title: "Live Music Night Poster", tag: "Event Poster" },
      { id: 4, type: "image", src: insta5, title: "Gourmet Bites Creative", tag: "Social Post" },
      { id: 5, type: "image", src: insta6, title: "VIP Lounge Signage", tag: "Display Graphics" },
    ],
  },
  {
    // id: "03",
    ...
    media: [
      { id: 1, type: "image", src: brand3, title: "Summer Linen Collection", tag: "Lookbook" },
      { id: 2, type: "image", src: insta7, title: "Kids Couture Showcase", tag: "Catalog" },
      { id: 3, type: "image", src: insta8, title: "E-Commerce Hero Banner", tag: "Web Banner" },
      { id: 4, type: "image", src: insta9, title: "Minimalist Brand Palette", tag: "Brand Guide" },
      { id: 5, type: "image", src: insta10, title: "Fabric Story Carousel", tag: "Social Post" },
    ],
  },
  {
    // id: "04",
    ...
    media: [
      { id: 1, type: "image", src: brand4, title: "Brand Identity & Key Visuals", tag: "Brand Identity" },
      { id: 2, type: "image", src: insta5, title: "Social Media Campaign 01", tag: "Social Media" },
      { id: 3, type: "image", src: insta6, title: "Premiere Experience Visuals", tag: "Promotion" },
      { id: 4, type: "image", src: insta7, title: "Dolby Atmos Acoustic Campaign", tag: "Audio-Visual" },
      { id: 5, type: "image", src: insta8, title: "Digital Display & Kiosk Design", tag: "Display Graphics" },
    ],
  },
  {
    // id: "05",
    ...
    media: [
      { id: 1, type: "image", src: brand5, title: "Signature Dish Feature", tag: "Food Photography" },
      { id: 2, type: "image", src: insta9, title: "Artisan Coffee Campaign", tag: "Beverage Visual" },
      { id: 3, type: "image", src: insta10, title: "Weekend Brunch Menu Placard", tag: "Print Menu" },
      { id: 4, type: "image", src: insta1, title: "Festive Dining Showcase", tag: "Social Creative" },
      { id: 5, type: "image", src: insta2, title: "Dessert Special Graphics", tag: "Promotion" },
    ],
  },
  {
    // id: "06",
    ...
    media: [
      { id: 1, type: "image", src: brand6, title: "Spirits & Spice Brand Emblem", tag: "Brand Identity" },
      { id: 2, type: "image", src: insta3, title: "Craft Mixology Showcase", tag: "Beverage Visual" },
      { id: 3, type: "image", src: insta4, title: "Signature Dining Lookbook", tag: "Menu Design" },
      { id: 4, type: "image", src: insta5, title: "Nightlife Moodboard", tag: "Social Campaign" },
      { id: 5, type: "image", src: insta6, title: "VIP Bar Signage", tag: "Display Graphics" },
    ],
  },
  {
    // id: "07",
    ...
    media: [
      ...
      { id: 2, type: "image", src: insta5, title: "Solitaire Diamond Close-up", tag: "Product Macro" },
      { id: 3, type: "image", src: insta6, title: "Festival Print Newspaper Ad", tag: "Print Ad" },
      { id: 4, type: "image", src: insta7, title: "Traditional Temple Ornaments", tag: "Social Post" },
      { id: 5, type: "image", src: insta8, title: "Exclusive Festive Lookbook", tag: "Catalog" },
    ],
  },
  {
    // id: "08",
    ...
    media: [
      { id: 1, type: "image", src: brand8, title: "Skyline Villa Elevation", tag: "Architecture" },
      { id: 2, type: "image", src: insta1, title: "Interior Blueprint Showcase", tag: "Design Render" },
      { id: 3, type: "image", src: insta2, title: "Site Hoarding Billboard", tag: "Outdoor Print" },
      { id: 4, type: "image", src: insta3, title: "Luxury Brochure Cover", tag: "Print Collateral" },
      { id: 5, type: "image", src: insta4, title: "Investor Presentation Slide", tag: "Digital Deck" },
    ],
  },
  {
    // id: "09",
    ...
    media: [
      { id: 1, type: "image", src: brand9, title: "Sunbeam Academic Identity", tag: "Identity Design" },
      { id: 2, type: "image", src: insta7, title: "Annual Day Theme Poster", tag: "Event Creative" },
      { id: 3, type: "image", src: insta8, title: "Campus Prospectus Layout", tag: "Print Work" },
      { id: 4, type: "image", src: insta9, title: "Student Achievement Banner", tag: "Social Media" },
      { id: 5, type: "image", src: insta10, title: "Curriculum Highlight Story", tag: "Digital Poster" },
    ],
  },
  {
    // id: "10",  
    ...
    media: [
      { id: 1, type: "image", src: brand10, title: "Corporate Identity & Logo System", tag: "Brand Identity" },
      { id: 2, type: "image", src: insta1, title: "Pharmaceutical Packaging Series", tag: "Packaging" },
      { id: 3, type: "image", src: insta2, title: "Medical Symposium Backdrop", tag: "Print Display" },
      { id: 4, type: "image", src: insta3, title: "Product Monograph Guide", tag: "Editorial" },
      { id: 5, type: "image", src: insta4, title: "Healthcare Awareness Carousel", tag: "Social Media" },
    ],
  },
];