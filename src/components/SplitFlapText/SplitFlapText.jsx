...
const DEFAULT_WORDS = ['VIDEO EDITOR', 'GRAPHIC DESIGNER', 'VISUAL CREATOR', 'CONTENT CREATOR'];
...
const SplitFlapText = ({
  words = ['VIDEO EDITOR', 'GRAPHIC DESIGNER', 'VISUAL CREATOR', 'CONTENT CREATOR'],
  text,
  flipDuration = 0.12,
  stagger = 0.05,
  cycleDelay = 2400,
  ...
  const componentStyle = {
    ...
    ...(gap !== undefined ? { '--split-flap-gap': toCssUnit(gap) } : {}),
    ...(fontSize !== undefined ? { '--split-flap-font-size': toCssUnit(fontSize) } : {}),
    ...style
  };
